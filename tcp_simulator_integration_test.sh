...
set_app_config 305419896 session_time_base 000000000000000000
...
require_line "TLV[0]: Config ID=0x2A (max_rr_retry), Length=2 bytes"
require_line "Interpreted: 4 (0x04 00) [Range: 0-65535]"
...
require_line "TLV[42]: Config ID=0x2A (max_rr_retry), Length=2 bytes"
