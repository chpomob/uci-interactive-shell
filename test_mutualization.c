...
int main() {
    ...
    printf("  Created struct - Session ID: 0x%08X, Type: %d\n", 
    ...
    printf("  Decoded struct - Session ID: 0x%08X, Type: %d\n", 
    ...
    printf("  Created struct - Session ID: 0x%08X\n", session_deinit.session_id);
    ...
    printf("  Decoded struct - Session ID: 0x%08X\n", decoded_session_deinit.session_id);
    ...
    printf("  Created session start struct - Session ID: 0x%08X\n", session_start.session_id);
    
    // This will internally validate and send the packet using the mutualized structure
    printf("  Sending SESSION_START command using mutualized structure...\n");
    uci_send_command_with_struct(COMMAND, COMPLETE, SESSION_CONTROL, SESSION_START, &session_start);
    printf("  ✓ Command sent successfully using mutualized structure!\n\n");
    
    // Test 4: Get format definition for a known command
    printf("Test 4: Getting payload format definition\n");
