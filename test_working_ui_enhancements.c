...
int main() {
    ...
    // Test all UI enhancement functions
    if (ui_color_enabled) {
    ...
    // Create a simulated ranging packet
    unsigned char ranging_packet[] = {
        0x21, 0x00, 0x00, 0x05,  // Header: NOTIFICATION, COMPLETE, SESSION_CONTROL, SESSION_INFO_NTF, payload_len=5
        0x01, 0x00, 0x00, 0x00, 0x00  // Payload
    };
    ...
    ui_print_packet_analysis(ranging_packet, sizeof(ranging_packet));
